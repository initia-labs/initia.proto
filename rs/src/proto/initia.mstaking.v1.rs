...
pub struct Validator {
    ...
    pub delegator_shares: ::prost::alloc::vec::Vec<super::super::super::cosmos::base::v1beta1::DecCoin>,
...
pub struct Params {
    ...
    /// minimum voting power to get into power update whitelist
    #[prost(uint64, tag="6")]
...
pub struct Pool {
    #[prost(message, repeated, tag="1")]
    pub not_bonded_tokens: ::prost::alloc::vec::Vec<super::super::super::cosmos::base::v1beta1::Coin>,
    #[prost(message, repeated, tag="2")]
